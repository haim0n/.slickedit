...
_menu _mdi_menu {
   submenu "&File","help file menu","Displays file menu","ncw" {
      ...
      "&Revert","revert","","help file menu","Revert current file to version on disk";
   ...
   submenu "&Edit","help edit menu","Displays edit menu","ncw" {
      ...
      submenu "&Delete","help delete menu","Displays menu for deleting text","ncw" {
         "&Word","cut-word","nicon|nrdonly","help delete menu","Deletes text from the cursor to the end of the current word and copies it to the clipboard";
   ...
   submenu "&Search","help search menu","Displays menu of search commands","ncw" {
      ...
      "&Toggle Bookmark","toggle-bookmark","ncw","help bookmarks","Toggles setting a bookmark on the current line";
      "&Bookmarks...","activate-bookmarks","ncw","help Bookmarks Tool Window","List bookmarks and allows you to add and delete bookmarks";
   ...
   submenu "&View","help view menu","Displays view menu","ncw" {
      ...
      "-","","","","";
      submenu "&Toolbars","","Show, hide, or customize a toolbar or tool window","ncw" {
   ...
   submenu "&Project","help project menu","Displays project menu","ncw" {
      "&New...","workspace-new","ncw","help New Project Tab","Allows you to create a workspace and/or project";
   ...
   submenu "&Help","help help menu","Displays menu of help commands","ncw" {
      ...
      "&Macro Functions by Category","help macro functions by category","ncw","help help menu","Allows you to choose help on macro functions by category";
...
_form _tbfilelist_form {
   ...
   _picture_box ctl_search_opt_button {
      p_auto_size=true;
      p_backcolor=0x80000005;
      p_border_style=BDS_FIXED_SINGLE;
      p_clip_controls=false;
      ...
      p_Nofstates=2;
      p_picture='_plusminus_chk.bmp';
      p_stretch=false;
      p_style=PSPIC_AUTO_CHECK;
      p_tab_index=21;
      p_value=1;
      p_width=180;
      p_x=0;
   ...
   _picture_box ctl_button_container {
      p_auto_size=false;
      p_backcolor=0x80000005;
      ...
      _image ctlbuffer_button {
         ...
         p_height=297;
         p_max_click=MC_SINGLE;
         p_message='View Open Files';
         p_Nofstates=2;
         p_picture='bbdocument.ico';
         p_stretch=false;
      ...
      _image ctlproject_button {
         ...
         p_height=297;
         p_max_click=MC_SINGLE;
         p_message='View Files in the Current Project';
         p_Nofstates=1;
         p_picture='bbproject.ico';
         p_stretch=false;
         p_style=PSPIC_HIGHLIGHTED_BUTTON;
         p_tab_index=2;
         p_value=0;
         ...
         p_x=405;
         p_y=0;
         p_eventtab=_tbfilelist_form.ctlbuffer_button;
         p_eventtab2=_ul2_picture;
      }
      _image ctlworkspace_button {
         p_auto_size=true;
         p_backcolor=0x80000005;
         p_border_style=BDS_NONE;
         p_forecolor=0x80000008;
         p_height=297;
         p_max_click=MC_SINGLE;
         p_message='View Files in the Current Workspace';
         p_Nofstates=1;
         p_picture='bbworkspace.ico';
         p_stretch=false;
         p_style=PSPIC_HIGHLIGHTED_BUTTON;
         p_tab_index=3;
         p_value=0;
      ...
      _image ctl_save_button {
         ...
         p_height=297;
         p_max_click=MC_SINGLE;
         p_message='Save Selected File(s)';
         p_Nofstates=1;
      ...
      _image ctl_close_button {
         ...
         p_height=297;
         p_max_click=MC_SINGLE;
         p_message='Close Selected Files(s)';
         p_Nofstates=1;
   ...
   _label ctlinfo_label {
      p_alignment=AL_LEFT;
      p_auto_size=true;
      p_backcolor=0x80000005;
      p_border_style=BDS_NONE;
      p_caption='ctlinfo_label';
      p_forecolor=0x80000008;
      p_height=176;
      p_tab_index=23;
      p_visible=false;
...
_form _tbfind_symbol_form {
   p_backcolor=0x80000005;
   p_border_style=BDS_SIZABLE;
   p_caption='Find Symbol';
   p_CaptionClick=true;
   p_clip_controls=false;
   p_forecolor=0x80000008;
   p_height=4158;
   p_help='Find Symbol tool window';
   p_picture='tbfindsymbol.bmp';
   p_tool_window=true;
   p_width=6972;
   p_x=8064;
   p_y=3553;
   p_eventtab=_tbfind_symbol_form;
   p_eventtab2=_toolbar_etab2;
   _label ctl_search_for_label {
      p_alignment=AL_LEFT;
      p_auto_size=true;
      p_backcolor=0x80000005;
      p_border_style=BDS_NONE;
      p_caption='&Search for:';
      p_forecolor=0x80000008;
      p_height=176;
      p_tab_index=1;
      p_width=768;
   ...
   _frame ctl_options_frame {
      ...
      p_x=3600;
      p_y=675;
      _picture_box ctl_options_button {
         p_auto_size=true;
         p_backcolor=0x80000005;
         p_border_style=BDS_FIXED_SINGLE;
         p_clip_controls=false;
      ...
      _label ctl_options_label {
         p_alignment=AL_LEFT;
         p_auto_size=false;
         p_backcolor=0x80000005;
         p_border_style=BDS_NONE;
         p_caption='Search &options';
         p_forecolor=0x80000008;
         p_height=396;
         p_tab_index=2;
         p_width=2874;
      ...
      _check_box ctl_case_sensitive {
         p_alignment=AL_LEFT;
         p_backcolor=0x80000005;
         p_caption='Match &case';
         p_forecolor=0x80000008;
         p_height=260;
      ...
      _check_box ctl_substring {
         p_alignment=AL_LEFT;
         p_backcolor=0x80000005;
         p_caption='&Match substring (slower)';
         p_forecolor=0x80000008;
         p_height=260;
      ...
      _check_box ctl_use_regex {
         p_alignment=AL_LEFT;
         p_backcolor=0x80000005;
         p_caption='&Use pattern (slower)';
         p_forecolor=0x80000008;
         p_height=260;
         p_style=PSCH_AUTO2STATE;
         p_tab_index=5;
   ...
   _image ctl_show_in_classes {
      ...
      p_height=297;
      p_max_click=MC_SINGLE;
      p_message='Show in symbol browser';
      p_Nofstates=1;
